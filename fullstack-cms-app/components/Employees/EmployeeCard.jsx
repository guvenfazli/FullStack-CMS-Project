...
export default function EmployeeCard({ employee }) {
  ...
  return (
    <div className="flex w-1/3 flex-col items-start justify-center rounded-md shadow-md bg-gradient-to-r from-gray-600 via-gray-700 to-gray-800 max-md:w-full">

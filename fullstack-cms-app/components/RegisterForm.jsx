  ...
  return (
    <div className="flex flex-col items-center w-2/6 max-lg:w-2/4 max-sm:w-4/5">
      <form className="flex flex-col text-xl py-6 px-8 w-full bg-gray-900 rounded-lg shadow-2xl max-lg:text-base max-sm:text-sm">
        ...
        <input name="name" id="name" className="text-gray-800 p-1 mb-3 rounded-md pl-2" placeholder="Enter Your Name"></input>
        <label htmlFor="surname" className="mb-3">Surname</label>
        <input name="surname" id="surname" className="text-gray-800 p-1 mb-3 rounded-md pl-2" placeholder="Enter Your Surname"></input>
        <label htmlFor="email" className="mb-3">Email Address</label>
        <input name="email" id="email" className="text-gray-800 p-1 mb-3 rounded-md pl-2" placeholder="Enter Your Username"></input>
        <label htmlFor="password" className="mb-3">Password</label>
        <input name="password" id="password" className="text-gray-800 p-1 rounded-md pl-2 mb-5" type="password" placeholder="Enter Your Password"></input>
        <label htmlFor="jobTitle" className="mb-3">Job Title</label>
        <input name="jobTitle" id="jobTitle" className="text-gray-800 p-1 mb-3 rounded-md pl-2" placeholder="Title"></input>
